...
namespace MasterFudge.Emulation.CPU
{
    ...
    public partial class Z80
    {
        ...
        static SimpleOpcodeDelegate[] opcodeTable_Main = new SimpleOpcodeDelegate[]
        {
            ...
            new SimpleOpcodeDelegate((c) => { c.ioWriteDelegate(c.ReadMemory8(c.pc++), c.af.High); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.JumpConditional16(c.IsFlagSet(Flags.C)); }),
            new SimpleOpcodeDelegate((c) => { c.af.High = c.ioReadDelegate(c.ReadMemory8(c.pc++)); }),
            new SimpleOpcodeDelegate((c) => { c.CallConditional16(c.IsFlagSet(Flags.C)); }),
        ...
        static SimpleOpcodeDelegate[] opcodeTable_CB = new SimpleOpcodeDelegate[]
        {
            ...
            new SimpleOpcodeDelegate((c) => { c.TestBit(c.ReadMemory8(c.hl.Word), 0); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.TestBit(c.ReadMemory8(c.hl.Word), 1); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.TestBit(c.ReadMemory8(c.hl.Word), 2); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.TestBit(c.ReadMemory8(c.hl.Word), 3); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.TestBit(c.ReadMemory8(c.hl.Word), 4); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.TestBit(c.ReadMemory8(c.hl.Word), 5); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.TestBit(c.ReadMemory8(c.hl.Word), 6); }),
            ...
            new SimpleOpcodeDelegate((c) => { c.TestBit(c.ReadMemory8(c.hl.Word), 7); }),
        ...
        static DDFDOpcodeDelegate[] opcodeTable_DDFD = new DDFDOpcodeDelegate[]
        {
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.LoadMemory16(c.ReadMemory16(c.pc), r.Word); c.pc += 2; }),
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { /* XXX */ r.High = c.ReadMemory8(c.pc++); }),
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.Add16(ref r, r.Word, false); }),
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.LoadRegister16(ref r.Word, c.ReadMemory16(c.ReadMemory16(c.pc))); c.pc += 2; }),
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { /* XXX */ r.Low = c.ReadMemory8(c.pc++); }),
            UnimplementedOpcodeDDFD,
			/* 0x30 */
			UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.LoadMemory8(c.CalculateIXIYAddress(r), c.ReadMemory8(c.pc++)); }),
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.bc.High = c.ReadMemory8(c.CalculateIXIYAddress(r)); }),
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.bc.Low = c.ReadMemory8(c.CalculateIXIYAddress(r)); }),
            UnimplementedOpcodeDDFD,
			/* 0x50 */
			UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.de.High = c.ReadMemory8(c.CalculateIXIYAddress(r)); }),
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.de.Low = c.ReadMemory8(c.CalculateIXIYAddress(r)); }),
            UnimplementedOpcodeDDFD,
			/* 0x60 */
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.hl.High = c.ReadMemory8(c.CalculateIXIYAddress(r)); }),
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.hl.Low = c.ReadMemory8(c.CalculateIXIYAddress(r)); }),
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.af.High = c.ReadMemory8(c.CalculateIXIYAddress(r)); }),
            UnimplementedOpcodeDDFD,
			/* 0x80 */
			UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.Add8(c.ReadMemory8(c.CalculateIXIYAddress(r)), false); }),
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.Add8(c.ReadMemory8(c.CalculateIXIYAddress(r)), true); }),
            UnimplementedOpcodeDDFD,
			/* 0x90 */
			UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.Subtract8(c.ReadMemory8(c.CalculateIXIYAddress(r)), false); }),
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.Subtract8(c.ReadMemory8(c.CalculateIXIYAddress(r)), true); }),
            UnimplementedOpcodeDDFD,
			/* 0xA0 */
			UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.And8(c.ReadMemory8(c.CalculateIXIYAddress(r))); }),
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.Xor8(c.ReadMemory8(c.CalculateIXIYAddress(r))); }),
            UnimplementedOpcodeDDFD,
			/* 0xB0 */
			UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.Or8(c.ReadMemory8(c.CalculateIXIYAddress(r))); }),
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            ...
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.Cp8(c.ReadMemory8(c.CalculateIXIYAddress(r))); }),
            UnimplementedOpcodeDDFD,
			/* 0xC0 */
			UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            ...
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            new DDFDOpcodeDelegate((Z80 c, ref Register r) => { c.ExecuteOpDDFDCB(c.ReadMemory8((ushort)(c.pc + 1)), ref r); }),
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
            UnimplementedOpcodeDDFD,
        ...
        static DDFDCBOpcodeDelegate[] opcodeTable_DDFDCB = new DDFDCBOpcodeDelegate[]
        {
            ...
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            new DDFDCBOpcodeDelegate((Z80 c, ref Register r, ushort address) => { c.TestBit(c.ReadMemory8(address), 0); }),
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            ...
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            new DDFDCBOpcodeDelegate((Z80 c, ref Register r, ushort address) => { c.TestBit(c.ReadMemory8(address), 1); }),
            UnimplementedOpcodeDDFDCB,
			/* 0x50 */
			UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            ...
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            new DDFDCBOpcodeDelegate((Z80 c, ref Register r, ushort address) => { c.TestBit(c.ReadMemory8(address), 2); }),
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            ...
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            new DDFDCBOpcodeDelegate((Z80 c, ref Register r, ushort address) => { c.TestBit(c.ReadMemory8(address), 3); }),
            UnimplementedOpcodeDDFDCB,
			/* 0x60 */
			UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            ...
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            new DDFDCBOpcodeDelegate((Z80 c, ref Register r, ushort address) => { c.TestBit(c.ReadMemory8(address), 4); }),
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            ...
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            new DDFDCBOpcodeDelegate((Z80 c, ref Register r, ushort address) => { c.TestBit(c.ReadMemory8(address), 5); }),
            UnimplementedOpcodeDDFDCB,
			/* 0x70 */
			UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            ...
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            new DDFDCBOpcodeDelegate((Z80 c, ref Register r, ushort address) => { c.TestBit(c.ReadMemory8(address), 6); }),
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            ...
            UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
            new DDFDCBOpcodeDelegate((Z80 c, ref Register r, ushort address) => { c.TestBit(c.ReadMemory8(address), 7); }),
            UnimplementedOpcodeDDFDCB,
			/* 0x80 */
			UnimplementedOpcodeDDFDCB,
            UnimplementedOpcodeDDFDCB,
